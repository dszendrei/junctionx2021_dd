...
(function (factory) {
    ...
    function paletteTemplate (p, color, className, opts) {
        ...
        for (var i = 0; i < p.length; i++) {
          if (i === 0 || i >= 4)
          {
            ...
            if(current) {
                ...
                if (i === 1) {
                  html.push('<span> high</span><br>');
                }
                if (i === 2) {
                  html.push('<span> mod.</span><br>');
                }
                if (i === 3) {
                  html.push('<span> low</span><br>');
                }
              } else {
        ...
        return "<div style='display:flex;flex-direction:column;' class='sp-cf " + className + "'>" + html.join('') + "</div>";
    }
